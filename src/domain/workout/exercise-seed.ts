...
const seedExerciseRecords = [
  {
    ...
    description:
      "Exercício fundamental de empurrar horizontal com barra e banco reto para desenvolvimento de peitorais e tríceps.",
    execution:
      "Descer a barra de forma controlada até a linha média do peitoral e empurrar mantendo as escápulas aduzidas e os pés firmes no solo.",
    instructions:
      "1. Ajuste a altura dos suportes e deite-se com os olhos alinhados à barra.\n2. Posicione os pés firmemente no chão e trave as escápulas no banco.\n3. Faça a pegada um pouco mais larga que os ombros.\n4. Tire a barra do suporte com os braços estendidos.\n5. Inspire e desça a barra até tocar suavemente o peito.\n6. Empurre a barra expirando o ar até a extensão quase completa dos cotovelos.",
    setup:
      "Banco reto plano, suporte de barra ajustado na altura dos punhos com braços estendidos e presilhas de segurança.",
    breathing:
      "Inspirar controladamente durante a descida e expirar durante o esforço máximo de subida.",
    mistakes:
      "Não perder a retração escapular, não abrir cotovelos a 90 graus (manter cerca de 75 graus) e não rebater a barra no esterno.",
    safetyNotes:
      "Em cargas elevadas, sempre utilize as barras de proteção (safety pins) ou solicite auxílio de um parceiro (spotter).",
    ...
    aliases: ["supino reto", "bench press", "supino com barra"],
    alternatives: [
      {
        ...
        publicReason:
          "Mesmo padrão de movimento com maior liberdade para a articulação dos ombros.",
      },
      {
        criteria: "Preferência por máquina ou foco em isolamento sem estabilização livre.",
        exerciseId: "machine-chest-press",
        label: "Supino reto na máquina",
        privateReasonCodes: ["equipment_preference"],
    ...
    adaptations: [
      {
        ...
        operationalResult:
          "Descer até 2 dedos antes do peito para preservar a cápsula articular do ombro.",
    ...
    progressions: [
      {
        ...
        publicReason:
          "Elimina a energia elástica muscular aumentando a força no ponto de estagnação.",
      },
    ],
    regressions: [
      {
  ...
  },
  {
    ...
    description:
      "Supino com halteres que proporciona maior arco de movimento, ativação simétrica dos membros e menor estresse nos ombros.",
    execution:
      "Deitar no banco plano segurando os halteres ao nível do peito e empurrar verticalmente aproximando no topo sem bater os pesos.",
    instructions:
      "1. Sente-se na ponta do banco com os halteres apoiados sobre os joelhos.\n2. Deite-se impulsionando os joelhos para levar os pesos até o peito.\n3. Firme os pés no chão e contraia o abdômen.\n4. Empurre os halteres para cima mantendo os antebraços sempre perpendiculares ao solo.\n5. Desça controladamente abrindo o peito até sentir bom alongamento.",
    ...
    mistakes:
      "Bater os halteres no topo, perder a estabilidade dos punhos e descer os cotovelos muito abaixo da linha dos ombros.",
    ...
    aliases: ["supino halter", "dumbbell press", "supino com halteres"],
    alternatives: [
      {
  ...
  },
  {
    ...
    description:
      "Supino horizontal articulado em máquina para hipertrofia com estabilidade total e isolamento peitoral.",
    execution:
      "Sentar ereto com peito estufado, empurrar as manoplas até quase estender os cotovelos e retornar alongando a musculatura.",
    instructions:
      "1. Ajuste a altura do banco para que as manoplas fiquem na linha média do peito.\n2. Apoie as costas e cabeça firmemente no encosto.\n3. Empurre expirando até a extensão quase completa dos cotovelos.\n4. Retorne controlando o peso sem deixar as placas baterem.",
    ...
    aliases: ["chest press", "supino maquina"],
    alternatives: [
      {
  ...
  },
  {
    ...
    description:
      "Desenvolvimento do feixe clavicular (porção superior) do peitoral maior com banco inclinado a 30-45 graus.",
    execution:
      "Deitar no banco inclinado e empurrar os halteres em trajetória convergente controlando o retorno.",
    instructions:
      "1. Ajuste a inclinação do banco para 30 a 45 graus.\n2. Sente-se e apoie os halteres nos joelhos.\n3. Deite-se posicionando os pesos na altura do peitoral superior.\n4. Empurre para cima expirando e desça abrindo os cotovelos a 70 graus.",
    setup: "Banco inclinado regulado entre 30 e 45 graus e par de halteres.",
    breathing: "Inspirar descendo e soltar o ar empurrando.",
    mistakes:
      "Inclinação muito alta (acima de 45 graus transfere a carga para os deltoides) e arquear a lombar tirando o glúteo do banco.",
    ...
    aliases: ["supino inclinado", "incline press"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
  ...
  },
  {
    ...
    description:
      "Padrão motor fundamental de agachamento com o peso do corpo para desenvolvimento dos membros inferiores e mobilidade de quadril.",
    execution:
      "Flexionar quadril e joelhos simultaneamente mantendo os calcanhares no chão e coluna neutra até as coxas ficarem paralelas ao chão.",
    instructions:
    ...
    mistakes:
      "Tirar os calcanhares do chão ou deixar os joelhos colapsarem para dentro (valgo dinâmico).",
    ...
    accessibleDescription:
      "Agachamento com peso corporal mantendo calcanhares no chão e tronco alinhado.",
    aliases: ["air squat", "agachamento peso do corpo"],
    alternatives: [
      {
  ...
  },
  {
    ...
    description:
      "Exercício de ouro para força máxima e hipertrofia global de membros inferiores e core.",
    execution:
      "Barra apoiada sobre o trapézio, agachar controlando o vetor vertical até a profundidade segura e subir com explosão firme.",
    instructions:
      "1. Entre sob a barra com pegada firme e posicione-a confortável no trapézio.\n2. Tire a barra do rack, dê dois passos para trás e alinhe os pés.\n3. Encha o abdômen de ar (manobra de Valsalva).\n4. Agache mantendo os joelhos alinhados com a ponta dos pés.\n5. Suba empurrando o chão e finalize a extensão do quadril no topo.",
    setup: "Rack de agachamento com barras de segurança travadas na altura correta.",
    breathing:
      "Inspiração profunda no topo, manter pressão intra-abdominal na descida e soltar o ar passando da metade da subida.",
    mistakes:
      "Inclinar o tronco excessivamente à frente e curvar a coluna lombar na parte mais profunda.",
    ...
    aliases: ["squat", "agachamento livre com barra"],
    alternatives: [
      {
  ...
  },
  {
    ...
    slug: "leg-press-45",
    description:
      "Padrão de flexão e extensão de pernas com suporte lombar e sobrecarga segura em plano inclinado.",
    execution:
      "Posicionar os pés na plataforma na largura do quadril, destravar as travas laterais e descer até 90 graus de joelho, subindo sem hiperestender.",
    instructions:
      "1. Sente-se no aparelho com o quadril totalmente colado no encosto.\n2. Posicione os pés na plataforma na largura dos ombros.\n3. Empurre para destravar a máquina com as mãos nas travas.\n4. Desça de forma suave até os joelhos formarem ângulo de 90 graus sem tirar o glúteo do banco.\n5. Empurre estendendo as pernas sem travar as articulações no topo.",
    ...
    mistakes:
      "Tirar o quadril do banco no ponto mais baixo (retroversão pélvica) e estalar os joelhos no topo com hiperflexão.",
    safetyNotes: "Mantenha as mãos sempre próximas às alavancas de segurança do aparelho.",
    movementPattern: "squat",
    primaryMuscles: ["quadríceps", "glúteo máximo"],
    secondaryMuscles: ["isquiotibiais"],
    equipment: ["plate_loaded_machine", "machine"],
    experienceLevel: "all_levels",
    defaultRestMin: 60,
    defaultRestMax: 90,
    estimatedSetDuration: 40,
  ...
  },
  {
    ...
    description:
      "Isolamento articular monoarticular para retificação e hipertrofia de todas as cabeças do quadríceps.",
    execution:
      "Sentar ajustando o rolo nos tornozelos, estender os joelhos completamente com breve contração no ápice e descer controlando.",
    instructions:
      "1. Ajuste o encosto de modo que o eixo do aparelho fique alinhado ao joelho.\n2. O rolo de apoio deve ficar sobre o dorso do pé/tornozelo.\n3. Segure firme nas alças laterais para prender o quadril.\n4. Estenda os joelhos até a contração máxima do quadríceps.\n5. Segure 1 segundo no topo e retorne devagar.",
    ...
    license: "CC BY 4.0",
    accessibleDescription:
      "Extensão de pernas na cadeira extensora para fortalecimento de quadríceps.",
    aliases: ["cadeira extensora", "extensora", "leg extension"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
  ...
  },
  {
    ...
    description:
      "Padrão de puxar horizontal unilateral com estabilização em banco plano, ideal para espessura das costas e ativação do latíssimo.",
    execution:
      "Apoiar joelho e mão no banco, manter a coluna alinhada ao chão e puxar o halter em direção à cintura puxando pelo cotovelo.",
    instructions:
      "1. Coloque o joelho e a mão do mesmo lado sobre o banco plano.\n2. Mantenha o outro pé firme no chão.\n3. Segure o halter com o braço estendido.\n4. Puxe o peso trazendo o cotovelo para cima e para trás até a altura do tronco.\n5. Desça alongando as costas sem curvar a espinha.",
    setup: "Banco plano e halter.",
    breathing: "Inspirar na descida do peso e soltar o ar na tração para cima.",
    mistakes:
      "Girar o tronco usando impulso do corpo ou puxar o peso na direção do peito em vez do quadril.",
    ...
    aliases: ["remada serrote", "dumbbell row", "serrote unilateral"],
    alternatives: [
      {
  ...
  },
  {
    ...
    description:
      "Exercício de puxar horizontal na polia com triângulo ou barra, excelente para espessura dorsal e romboides.",
    execution:
      "Sentar ereto com pés nas plataformas e puxar o pegador até o abdômen aproximando as escápulas.",
    instructions:
      "1. Sente-se e apoie os pés nas plataformas com joelhos levemente flexionados.\n2. Segure o triângulo e retorne a coluna para posição vertical ereta.\n3. Puxe em direção ao umbigo jogando os ombros e escápulas para trás.\n4. Estenda os braços controlando o retorno sem curvar excessivamente o tronco à frente.",
    ...
    aliases: ["remada sentada", "remada baixa", "cable row"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
  ...
  },
  {
    ...
    description:
      "Exercício clássico de puxar vertical para expansão de largura das costas (asa dorsal) e desenvolvimento de força escapular.",
    execution:
      "Sentar ajustando as coxas, segurar a barra aberta e puxar verticalmente até a altura do peitoral superior com peito estufado.",
    instructions:
      "1. Ajuste os rolos de suporte das coxas com firmeza.\n2. Segure a barra longa com pegada pronada na largura das curvas.\n3. Sente-se com o tronco levemente inclinado para trás (10 graus).\n4. Puxe a barra em direção ao queixo/peito superior conduzindo pelos cotovelos.\n5. Retorne os braços esticando totalmente os dorsais.",
    ...
    mistakes:
      "Puxar a barra por trás da nuca ou deitar excessivamente o tronco usando o peso corporal.",
    ...
    aliases: ["puxada frente", "lat pulldown", "puxador costas"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
  ...
  },
  {
    ...
    description:
      "Exercício de empurrar vertical essencial para hipertrofia, força e arredondamento estético dos deltoides.",
    execution:
      "Sentar no banco inclinado a 80 graus, erguer os halteres até a linha dos ombros e empurrar verticalmente acima da cabeça.",
    instructions:
      "1. Ajuste o banco em ângulo quase reto (80-85 graus).\n2. Sente-se com as costas coladas e halteres na altura das orelhas.\n3. Cotovelos levemente à frente no plano escapular (não 100% abertos).\n4. Empurre os halteres para o alto aproximando-os no topo sem encostar.\n5. Desça com controle até a altura do queixo/orelhas.",
    setup: "Banco regulável e par de halteres.",
    breathing: "Inspirar na descida e expirar durante o empurrão vertical.",
    mistakes:
      "Arquear a coluna lombar afastando as costas do banco e empurrar com cotovelos muito para trás.",
    ...
    aliases: ["shoulder press", "desenvolvimento ombros", "press de ombro"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
  ...
  },
  {
    ...
    description:
      "Exercício de isolamento fundamental para largura e definição do feixe medial (lateral) do deltoide.",
    execution:
      "Em pé com tronco levemente inclinado, elevar os halteres lateralmente até a altura dos ombros mantendo cotovelos firmes.",
    instructions:
      "1. Em pé com pés afastados, segure um halter em cada mão à frente das coxas.\n2. Incline levemente o tronco à frente (5 graus) e dobre sutilmente os cotovelos.\n3. Eleve os braços lateralmente até que fiquem na linha dos ombros.\n4. Segure um breve instante no topo e desça com freio excêntrico.",
    setup: "Par de halteres de carga leve a moderada.",
    breathing: "Soltar o ar na subida e puxar o ar na descida lenta.",
    mistakes:
      "Usar balanço do quadril (roubar) e elevar os pesos acima da linha dos ombros ativando o trapézio.",
    safetyNotes:
      "Mantenha o polegar levemente apontado para baixo ou neutro para evitar pinçamento no ombro.",
    ...
    aliases: ["elevacao lateral", "lateral raise"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
  ...
  },
  {
    ...
    description:
      "Padrão motor de dobradiça de quadril (hinge) com foco em glúteos, posteriores de coxa e estabilidade postural eretora.",
    execution:
      "Empurrar o quadril para trás com joelhos semiflexionados descendo os halteres rentes às pernas até o meio da tíbia e retornar contraindo glúteos.",
    instructions:
      "1. Fique em pé com os halteres na frente das coxas.\n2. Mantenha os joelhos destravados (leve flexão mantida fixa).\n3. Jogue o quadril para trás como se quisesse tocar uma parede com o bumbum.\n4. Desça até sentir o alongamento pleno dos posteriores de coxa.\n5. Volte impulsionando o quadril para a frente e contraia os glúteos no topo.",
    setup: "Par de halteres e espaço livre.",
    breathing: "Inspirar descendo com a coluna selada e soltar o ar ao subir.",
    mistakes:
      "Arredondar a coluna lombar (coluna em C) ou flexionar os joelhos transformando em agachamento.",
  ...
  },
  {
    ...
    slug: "mesa-flexora",
    description:
      "Isolamento mecânico direto dos isquiotibiais (posterior da coxa) em posição deitada.",
    execution:
      "Deitar de bruços no aparelho com o rolo acima do calcanhar, flexionar os joelhos até contração total e descer controladamente.",
    instructions:
      "1. Deite-se no aparelho com os joelhos alinhados com o eixo de rotação da máquina.\n2. Posicione o rolo almofadado atrás dos tornozelos.\n3. Segure firme nos apoios para manter a pelve pressionada contra o banco.\n4. Puxe os calcanhares em direção aos glúteos o máximo que conseguir.\n5. Retorne estendendo as pernas de forma suave.",
    ...
    aliases: ["mesa flexora", "flexora deitada", "leg curl"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
  ...
  },
  {
    ...
    description:
      "Exercício de isolamento clássico para hipertrofia dos bíceps braquial e braquiorradial com rotação supinada.",
    execution:
      "Em pé com cotovelos colados ao tronco, flexionar os braços girando os punhos para cima e descer com controle total.",
    instructions:
      "1. Em pé com postura ereta, segure os halteres ao lado do corpo.\n2. Inicie a flexão girando a palma da mão para cima (supinação).\n3. Contraia o bíceps com força no topo sem levantar os cotovelos.\n4. Desça de forma lenta sentindo a extensão controlada do braço.",
    ...
    aliases: ["rosca direta", "bicep curl", "rosca com halteres"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
  ...
  },
  {
    ...
    aliases: ["triceps corda", "triceps polia", "rope pushdown"],
    alternatives: [],
    adaptations: [],
    progressions: [],
    regressions: [],
